...
source_folder = 'New_photo/obj_Train_data'
target_folder = os.path.join(os.path.dirname(source_folder), 'obj_Train_data_new')
source_folder1 = 'New_photo/obj_Validation_data'
target_folder1 = os.path.join(os.path.dirname(source_folder), 'obj_Validation_data_new')
# Specify the target extension

target_extension = 'jpg'  # or 'jpg' or 'jpeg

# Call the function
copy_files_and_convert_images(source_folder, target_folder, target_extension)
copy_files_and_convert_images(source_folder1, target_folder1, target_extension)